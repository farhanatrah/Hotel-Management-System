...
<body>
    ...
    <table>
        ...
        <?php
        $sql ="SELECT * FROM invoice WHERE inv_status ='COMPLETE'";
        ...
        while($run = mysqli_fetch_array($query))
        {
            ?>
            <tr align="center">
                <td><?php echo $run['inv_date'] ?></td>
                <td><?php echo $run['inv_num'] ?></td>
                <td><?php echo $run['inv_status'] ?></td>
                <td><?php echo $run['room_total'] ?></td>
        </tr>
    
        <?php $totsales =$totsales + $run['room_total']; } ?>
        </table>
        <br>
        <center><h2>Total Sales of Month RM: <?php echo $totsales ?></h2></center>
        </div>
